 ...
 */
final class Version20210411200625 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE banners (id INT AUTO_INCREMENT NOT NULL, orden SMALLINT NOT NULL, imagen VARCHAR(255) NOT NULL, habilitado TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
