 ...
 */
final class Version20210309221813 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE productos ADD precio DOUBLE PRECISION DEFAULT NULL, CHANGE marca_id marca_id INT DEFAULT NULL, CHANGE id_externo id_externo INT DEFAULT NULL, CHANGE descripcion descripcion VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE productos DROP precio, CHANGE marca_id marca_id INT DEFAULT NULL, CHANGE id_externo id_externo INT DEFAULT NULL, CHANGE descripcion descripcion VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
